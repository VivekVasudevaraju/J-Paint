...
public class ApplicationState implements IApplicationState {
    ...
    @Override
    public void setActiveShape(ShapeType shape) {
        if (shape != null) {
    ...
    @Override
    public void setActiveShadingType(ShapeShadingType shapeShade) {
        if (shapeShade != null) {
            activeShapeShadingType = shapeShade;
            return;
        }
    ...
    @Override
    public void setActiveStartAndEndPointMode(MouseMode mode) {
        if (mode != null) {
