...
/**
 * Ellipse class to draw an Ellipse
 */
public class Ellipse extends AbstractShape implements IDraw {
    ...
    /**
     * Set ellipse values before drawing shape
     */
    public Ellipse(Point startingPoint, Point endingPoint, PaintCanvasBase paintCanvas, IApplicationState appState) {
    ...
    public void drawShape() {
        ...
        switch (getShapeShadingType()) {
            case FILLED_IN:
                ...
                graphics2d.fillOval(XCoordinate, YCoordinate, width, height);
                break;
            ...
            case OUTLINE:
                ...
                graphics2d.drawOval(XCoordinate, YCoordinate, width, height);
                break;

            case OUTLINE_AND_FILLED_IN:
                graphics2d.setStroke(stroke);
                graphics2d.setColor(strokeColor);
                graphics2d.drawOval(XCoordinate-3, YCoordinate-3, width+5, height+5);
                graphics2d.setColor(ColorPattern.getColor(getPrimaryColor()));
                graphics2d.fillOval(XCoordinate, YCoordinate, width, height);
                break;
        }
    ...
    public void moveShape(int transformOffsetX, int transformOffsetY) {
        ...
        setXCoordinate(XCoordinate + transformOffsetX);
        setYCoordinate(YCoordinate + transformOffsetY);
    }
