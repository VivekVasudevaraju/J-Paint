...
/**
 * Triangle class to draw an Triangle
 */
public class Triangle extends AbstractShape implements IDraw {
    ...
    public Triangle(Point startingPoint, Point endingPoint, PaintCanvasBase paintCanvas, IApplicationState appState) {
    ...
    public void drawShape() {
        ...
        if (startingPoint.x > endingPoint.x) {
            midPoint = new Point((endingPoint.x + (Math.abs(startingPoint.x - endingPoint.x)/2)), (int) endingPoint.getY());
        } else {
            midPoint = new Point((endingPoint.x - (Math.abs(startingPoint.x - endingPoint.x)/2)), (int) endingPoint.getY());
        }

        int[] xPoints = { startingPoint.x, endingPoint.x, midPoint.x };
        int[] yPoints = { startingPoint.y, startingPoint.y, midPoint.y };
